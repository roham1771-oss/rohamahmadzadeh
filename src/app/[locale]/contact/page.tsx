            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                {[
                  ...
                  { icon: <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" /></svg>, label: params.locale === 'fa' ? 'موبایل' : 'Mobile', value: isRTL ? CONTACT_INFO.mobile : CONTACT_INFO.mobileEn, dir: 'ltr' },
