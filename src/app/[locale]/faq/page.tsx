...
export default async function FAQPage({ params }: FAQPageProps) {
  ...
  const faqs = [
    { id: '1', questionFa: 'هزینه مشاوره حقوقی چقدر است؟', questionEn: 'How much does legal consultation cost?', answerFa: 'هزینه مشاوره بسته به نوع پرونده و موضوع حقوقی متفاوت است. برای اطلاع از هزینه‌ها با ما تماس بگیرید.', answerEn: 'Consultation fees vary depending on the type of case and legal matter. Please contact us for more information.', category: 'عمومی', sortOrder: 1, isActive: true },
