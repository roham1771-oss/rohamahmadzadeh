      ...
      >
        <div className="p-6 space-y-6">
          ...
          <div className="pt-4 border-t border-border/50 space-y-3">
            ...
            <a href={`tel:${CONTACT_INFO.mobileEn}`} className="flex items-center gap-3 px-4 py-2.5 rounded-xl hover:bg-muted/50 transition-colors text-sm">
              <div className="w-8 h-8 bg-accent-500/10 rounded-lg flex items-center justify-center shrink-0">
                <svg className="w-4 h-4 text-accent-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
                </svg>
              </div>
              <span dir="ltr">{locale === 'fa' ? CONTACT_INFO.mobile : CONTACT_INFO.mobileEn}</span>
            </a>
          </div>
